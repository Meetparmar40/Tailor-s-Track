...
import CustomerMiniCard from "../components/layout/SheetView/ui/CustomerMiniCard";
...
export default function OrderDetailsPage() {
    ...
    const isNew = id === "new";
    const order = isNew ? {} : orders.find((o) => String(o.id) === String(id));
    ...
    return <OrderDetailsContent order={order} navigate={navigate} />;
}

function OrderDetailsContent({ order, navigate }) {
    const ctrl = useOrderSheetController({ order, onClose: () => navigate(-1) });
