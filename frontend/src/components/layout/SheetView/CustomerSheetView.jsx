...
import { PlusCircle, ChevronDown, ChevronUp, Edit2, Trash2, Check, X } from "lucide-react";

import useCustomerSheetController from "./controllers/useCustomerSheetController";
import SectionCard from "./ui/SectionCard";

import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { MEASUREMENT_TEMPLATES, CLOTH_TYPES } from "./measurementTemplates.js";

export default function CustomerSheetView({ customer, open, onOpenChange }) {
  const customerCtrl = useCustomerSheetController({ customer, onClose: () => onOpenChange(false) });
          ...
          <div className="p-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="bg-muted/30 rounded-lg p-4 max-h-[400px] overflow-y-auto border border-muted/50">
                  {state.loadingOrders ? (
